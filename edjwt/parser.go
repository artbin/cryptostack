...
func (p *Parser) Parse(tokenString string, pkey *cryptostack.Pkey /*keyFunc Keyfunc*/) (*Token, error) {
	...
	if err = pkey.Verify([]byte(strings.Join(parts[0:2], ".")), []byte(token.Signature)); err != nil {
		vErr.err = err.Error()
